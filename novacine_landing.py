...
st.set_page_config(
    page_title="NovaCine AI Cinematic Video Studio",
    page_icon="🎬",
    layout="wide"
)
...
.hero-bg{
    ...
    inset:0;
    background:
        radial-gradient(ellipse 80% 60% at 50% 20%,rgba(124,92,252,.18) 0%,transparent 70%),
        radial-gradient(ellipse 50% 40% at 80% 80%,rgba(196,92,252,.1) 0%,transparent 60%);
    pointer-events:none;
}
...
.btn-primary:hover{
    ...
    box-shadow:0 0 50px rgba(124,92,252,.5);
}
...
.video-mock{
    width:100%;
    aspect-ratio:16/9;
    background:linear-gradient(135deg,#0d0d1f,#1a1030,#0d0d1f);
    display:flex;
    align-items:center;
    justify-content:center;
    position:relative;
...
.studio-card.cinema{
    background:linear-gradient(135deg,rgba(124,92,252,.12),rgba(196,92,252,.08));
}

.studio-card.marketing{
    background:linear-gradient(135deg,rgba(92,184,252,.1),rgba(124,92,252,.08));
}
...
.price-card.pro{
    ...
    background:linear-gradient(160deg,rgba(124,92,252,.1),var(--card));
}
...
.cta-bg{
    position:absolute;
    inset:0;
    background:radial-gradient(ellipse 70% 60% at 50% 50%,rgba(124,92,252,.14) 0%,transparent 70%);
    pointer-events:none;
}
...
<section class="hero">
    ...
    <div>
        <div class="badge">
            ...
            Now with Seedance 2.0 · Kling 3.0 · Veo 3.1
        </div>

        <h1>
            Create <span>Cinematic AI Videos</span><br>
            Like a Hollywood Director
        </h1>

        <p>
            All the world's best AI video models in one creative workspace.
            Generate, direct, and publish stunning videos — from a single prompt.
        </p>

        <div class="hero-btns">
            <a href="#pricing" class="btn-primary">Start Creating Free</a>
            <a href="#features" class="btn-secondary">Watch Demo</a>
        </div>
...
<div class="stats">
    <div class="stat">
        ...
        <div class="stat-label">Creators worldwide</div>
    </div>
...
<section style="padding:5rem 5%;background:var(--bg)">
    ...
    <div class="section-sub">
        Pick the best engine for each project — speed, fidelity, dialogue, or multi-shot continuity.
    </div>

    <div class="models-grid">
        <div class="model-pill">
            <div class="name">Seedance 2.0</div>
            <div class="tag">Best overall</div>
        </div>

        <div class="model-pill">
            <div class="name">Kling 3.0</div>
            <div class="tag">Lip-sync</div>
        </div>

        <div class="model-pill">
            <div class="name">Veo 3.1</div>
            <div class="tag">Realism</div>
        </div>
        ...
        <div class="model-pill">
            <div class="name">Wan 2.7</div>
            <div class="tag">Multi-shot</div>
        </div>

        <div class="model-pill">
            <div class="name">MiniMax H02</div>
...
<section id="studios" style="padding:5rem 5%;background:var(--bg2)">
    ...
    <div class="studios-grid">
        <div class="studio-card cinema">
            ...
            <p>
                Think in scenes and sequences. Real film terminology.
                Hollywood-grade output.
            </p>
        ...
        <div class="studio-card marketing">
            <div class="studio-badge" style="background:rgba(92,184,252,.2);border-color:rgba(92,184,252,.3);color:var(--accent3)">
                Marketing Studio
            </div>
            ...
            <p>
                URL to ad in seconds. Scale campaigns without scaling your budget or team.
            </p>
...
<section class="pricing" id="pricing">
    ...
    <div class="pricing-grid">
        <div class="price-card">
            ...
            <a href="#" class="btn-secondary" style="width:100%;border-radius:10px;padding:.8rem;text-align:center">
                Get Started Free
            </a>
        </div>
        ...
        <div class="price-card pro">
            ...
            <div class="desc">
                For creators who ship daily and need top quality at speed.
            </div>
            ...
            <a href="#" class="btn-primary" style="width:100%;border-radius:10px;text-align:center">
                Start Pro Trial
            </a>
        </div>
        ...
        <div class="price-card">
            ...
            <div class="desc">
                For agencies, studios, and Fortune 500 teams.
            </div>
...
<section class="cta-section">
    ...
    <h2>
        Your first cinematic video<br>
        is one prompt away
    </h2>

    <p>
        Join 20 million creators already making Hollywood-grade content with NovaCine.
        Free forever. No credit card needed.
    </p>

    <a href="#pricing" class="btn-primary" style="font-size:1.05rem;padding:1rem 2.8rem">
...
<footer>
    ...
    <div class="footer-copy">
        © 2026 NovaCine Inc. All rights reserved.
    </div>
</footer>
...
components.html(html_code, height=6500, scrolling=True)
